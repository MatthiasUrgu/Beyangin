...
import ButtonGenearator from '../ButtonGenearator/ButtonGenearator'
    ...
    function CardItems({CrossImage1,CrossImage2,CrossImage3,CrossImage4,title,subtitle}){
        ...
        <button  className={s.icon}><span><FaPlay/></span></button>
        <h1>{title}</h1>
        <p>{subtitle}</p>
        <ButtonGenearator ddd='Learn more'/>
